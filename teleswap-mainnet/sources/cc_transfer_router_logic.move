...
module teleswap::cc_transfer_router_logic {
    ...
    public fun wrap(
        ...
        let (amount,received_amount,network_fee,locker_fee,protocol_fee,third_party_fee,rewarder_fee,recipient_address) = mint_and_distribute(router, locker_cap, locker_locking_script, tx_id, telebtc_cap, treasury_cap, clock, ctx);
